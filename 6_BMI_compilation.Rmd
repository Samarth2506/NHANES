...
g1 = ggplot(data.frame(res_RMSE)) + 
  ...
  labs(x = 'Number of Principal Components in Cross-Validation',y = 'Root Mean Square Error ')
...
g2 = ggplot(data.frame(res_Rsquared)) + 
  ...
  # geom_smooth(se = TRUE, method = 'lm')+
  geom_smooth(se = TRUE, method =  'auto',color = 'blue') + 
  labs(x = 'Number of Principal Components in Cross-Validation',y = 'R-squared')
