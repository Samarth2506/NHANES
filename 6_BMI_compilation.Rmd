...
ggplot(tmp, aes(x = 1:n)) + 
  ...
  geom_line(aes(y = tmp[,2], color = "Participant with Highest Principal Component scores")) +
  geom_line(aes(y = tmp[,3], color = 'Participant with Lowest Principal Component scores')) + 
