...
return(
  ggplot() +
    geom_line(data = temp_high, aes(x = 1:nrow(temp_high)/60, y = temp_high[1] %>% unlist(), color = 'Scores of Subjects with High BMI')) + 
    geom_line(data = temp_low, aes(x = 1:nrow(temp_low)/60, y = temp_low[1] %>% unlist(), color = 'Scores of Subjects with Low BMI')) + 
