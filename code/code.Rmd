...
library(factoextra)
fviz_eig(pca_model,
         main = 'PCA Scree Plot of Physical Activity Data')
...
corrplot(res_cor,
         ...
         tl.srt = 30,
         mar=c(0,0,5,0),
         title = "Pearson’s Correlation Analysis between BMI, Covariates and Physical Activity")
# mtext("Pearson’s Correlation Analysis between BMI, Covariates and Physical Activity", at=5, line=1.5, cex=1.5)
...
if(F){
  ...
  save(model,res_RMSE,res_Rsquared, file = 'CV_50PCs.rda')
}
